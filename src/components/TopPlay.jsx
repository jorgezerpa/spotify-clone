...
const TopPlay = () => {
  ...
  return(
    <div ref={divRef} className="xl:ml-6 ml-0 xl:mb-0 mb-6 md:pt-0 pt-10 flex-1 xl:max-w-[400px] max-w-full flex flex-col">
      ...
      <div className="w-full flex flex-col mt-8">
        ...
        <Swiper slidesPerView='auto' spaceBetween={15} freeMode centeredSlides centeredSlidesBounds modules={[FreeMode]} className="mt-4"  >
            { topPlays?.map((song, i) => (
              <SwiperSlide key={`swuper-${song?.key}`} style={{width:'20%', height: 'auto'}} className="shadow-lg rounded-full animate-slideright" >
                <Link to={`/artists/${song?.artists[0].adamid}`} >
